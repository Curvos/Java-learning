...
public class DataBase
{
	...
	// private static final String inLocation = "import/import_data.txt";
	private static final String inLocation = "import/import_data.txt";
	private static final String exLocation = "export/export.txt";
	public static StringBuffer export;
	...
	private static Object[][] convert(ResultSet rs) throws SQLException
	{
		...
		{
			// export.append(m.getColumnTypeName(i));
			// export.append('\t');
			System.out.print(m.getColumnName(i));
			System.out.print("\t\t");
		}
		System.out.println();
		objs = new Object[rows][columns];
		int temp = 0;
		// 显示表格内容
		while (rs.next())
		{
			...
			for (int i = 1; i <= columns; i++)
			{
				// export.append(rs.getString(i));
				// export.append(rs.getString('\t'));
	...
	public static void Import() throws SQLException, FileNotFoundException
	{
		...
		// stmt.execute("load data local infile \"import/import_data.txt\" into
		// table table_1530416012;");
		String sql = "load data local infile" + " \"" + inLocation + "\" " + "into table table_1530416012;";
		stmt.execute(sql);
